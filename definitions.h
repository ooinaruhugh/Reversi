...
#define A_TIER 0x182424180000
#define B_TIER 0x240000240000
#define D_TIER 0x24420000422400
#define E_TIER 0x18004242001800
#define F_TIER 0x1800008181000018
#define G_TIER 0x2400810000810024
...
typedef enum Delta
{
  DOWN = BOARD_WIDTH, // 8
  DRIGHT = 1, // 1
  DOWN_RIGHT = BOARD_WIDTH + 1, // 9
  DOWN_LEFT = BOARD_WIDTH - 1, // 7
  UP = -BOARD_WIDTH, // -8
  DLEFT = -1, // -1
  UP_RIGHT = -BOARD_WIDTH + 1, // -7
  UP_LEFT = -(BOARD_WIDTH + 1), // -9
} DELTA;
