...
{
  return CORNERS & pos ? 10 : C_SPOTS & pos ? 1 : X_SPOTS & pos ? 2 : ONE_SPOTS & pos ? 1 : TWO_SPOTS & pos ? 3 : FOUR_SPOTS & pos ? 4 : SIX_SPOTS & pos ? 6 : 0;
}
...
Bitboard this_players_turn(Game *g)
{
  return some_move(most_promising_move(g->legal_moves));
}